      ...
      >
        <div className="container mx-auto text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="bg-transparent border-white text-white hover:bg-white hover:text-primary">Join the Movement</Button>
          </div>
        </div>
      </motion.section>
          ...
          <div className="relative border-l-2 border-primary/50 ml-6 md:ml-0">
           ...
           <div className="text-center mt-12">
            <Button size="lg" asChild>
              <Link href="/join">Join us on this journey</Link>
            </Button>
          </div>
        </div>
      </motion.section>
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <Button asChild variant="outline">
              <Link href="/join">Want to collaborate with us? <span className="ml-2">🤝</span></Link>
          </Button>
        </div>
      </motion.section>
