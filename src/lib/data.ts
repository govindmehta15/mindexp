...
export const resources: Resource[] = [
    { id: 'res-1', title: 'Managing Stress and Anxiety', type: 'Article', topic: 'Mental Health', language: 'English', rating: 4.8, imageUrl: 'https://picsum.photos/seed/202/400/225', imageHint: 'reading book', description: 'An in-depth article on cognitive-behavioral techniques to manage academic stress.', comments: [] },
    { id: 'res-2', title: 'Beginner\'s Guide to Mindfulness', type: 'Video', topic: 'Mental Health', language: 'English', rating: 4.9, imageUrl: 'https://picsum.photos/seed/201/400/225', imageHint: 'laptop video', description: 'A guided video session on mindfulness meditation for students.', comments: [] },
    { id: 'res-3', title: 'The Science of Procrastination', type: 'Podcast', topic: 'Academics', language: 'English', rating: 4.6, imageUrl: 'https://picsum.photos/seed/203/400/225', imageHint: 'microphone podcast', description: 'Listen to experts discuss why we procrastinate and how to overcome it.', comments: [] },
    { id: 'res-4', title: 'Navigating University Life', type: 'Guide', topic: 'Homesickness', language: 'Spanish', universityAffiliation: 'State University', rating: 4.7, imageUrl: 'https://picsum.photos/seed/204/400/225', imageHint: 'campus guide', description: 'A comprehensive guide for new students at State University.', comments: [] }
];
